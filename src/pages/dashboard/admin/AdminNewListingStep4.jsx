/* src/pages/dashboard/admin/AdminNewListingStep4.jsx */
...
const AdminNewListingStep4 = () => {
    ...
    const checklist = [
      { id: 'title', label: 'Listing Title', status: !!listingData.title, step: '/admin/listings/new/step-1' },
      { id: 'price', label: 'Target Price', status: !!listingData.price_pula, step: '/admin/listings/new/step-1' },
      { id: 'location', label: 'Property Location', status: !!listingData.location, step: '/admin/listings/new/step-1' },
      { id: 'coordinates', label: 'GPS Coordinates', status: !!listingData.latitude && !!listingData.longitude, step: '/admin/listings/new/step-1' },
      { id: 'description', label: 'Property Narrative', status: listingData.description?.length > 20, step: '/admin/listings/new/step-1' },
      { id: 'specs', label: 'Technical Specs', status: listingData.bedrooms > 0 && listingData.bathrooms > 0, step: '/admin/listings/new/step-2' },
      { id: 'media', label: 'Hero Visuals', status: listingData.images?.length > 0, step: '/admin/listings/new/step-2' },
      { id: 'compliance', label: 'Legal Compliance', status: Object.values(listingData.documents).every(v => v === true), step: '/admin/listings/new/step-3' },
    ];

  return (
    <AdminDashboardLayout title="Authority Review & Publish">
      <div className="max-w-6xl mx-auto pb-32">
        <div className="mb-16 flex flex-col md:flex-row md:items-end justify-between gap-12 text-on-surface">
          <div>
            <span className="text-primary font-black tracking-widest uppercase mb-3 block text-[10px]">Administrative Final Step</span>
            <h1 className="text-5xl font-extrabold tracking-tighter leading-tight font-headline">Verify & <br/>Authorize</h1>
          </div>
        ...
        <div className="grid grid-cols-12 gap-10">
          <div className="col-span-12 lg:col-span-8 space-y-12">
            <div className="bg-surface-container-lowest rounded-3xl p-10 shadow-authoritative transition-all hover:shadow-xl border border-outline-variant/10">
              <div className="flex items-center justify-between mb-10">
                <h2 className="text-2xl font-[800] tracking-tight text-on-surface font-headline leading-none text-on-surface/80">Asset Summary</h2>
                <button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-12 gap-x-16">
                ...
                <div className="col-span-1 md:col-span-2 pt-8 border-t border-outline-variant/10 text-on-surface">
          ...
          <div className="col-span-12 lg:col-span-4 translate-y-0 lg:-translate-y-20">
            <div className="sticky top-28 space-y-8">
              <div className="bg-surface-container-lowest rounded-3xl p-10 shadow-authoritative border border-outline-variant/10">
                <h3 className="text-2xl font-[800] text-on-surface font-headline leading-none mb-8">Authorize Asset</h3>
                <div className="space-y-4 mb-10 text-on-surface">
                  <div className="flex items-center justify-between py-4 border-b border-outline-variant/10">
                    ...
                    <span className="text-sm font-bold">Standard 30D</span>
                  </div>
                  <div className="flex items-center justify-between py-4 border-b border-outline-variant/10">
                    <span className="text-xs font-black uppercase tracking-widest text-outline/40">Security</span>
                    <span className="text-sm font-bold text-secondary">Pre-Verified</span>
                  </div>
                  <div className="flex items-center justify-between py-4">
                    <span className="text-xs font-black uppercase tracking-widest text-outline/40">Authority</span>
                ...
                >
                  {isSubmitting ? 'Authorizing...' : 'Authorize Listing'}
                </button>
                <button 
                  disabled={isSubmitting}
      ...
      <footer className="fixed bottom-0 left-0 lg:left-[260px] right-0 bg-white/90 backdrop-blur-xl px-4 lg:px-16 py-8 border-t border-outline-variant/10 z-50 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-outline/40">
        <div className="flex gap-12">
          <div className="space-y-1">
            <span className="opacity-40">Authority ID</span>
            <p className="text-on-surface opacity-100 uppercase">Au-Admin-{new Date().getFullYear()}</p>
          </div>
          <div className="space-y-1">
            <span className="opacity-40">System Standard</span>
            <p className="text-on-surface opacity-100">ISO-Verified</p>
          </div>
        </div>
      </footer>
...
export default AdminNewListingStep4;
