/* src/pages/dashboard/MessagesLocked.jsx */
import React from 'react';
import DashboardLayout from '../../components/dashboard/DashboardLayout';
import { useNavigate } from 'react-router-dom';

const MessagesLocked = () => {
    ...
    <DashboardLayout title="Messages">
      <div className="relative flex flex-col items-center justify-center min-h-[60vh] text-center px-6">
        ...
        <p className="font-body text-secondary text-lg mb-10 leading-relaxed max-w-xl">
          Direct communication with property owners and agents is exclusive to our Intelligence Dossier Pro members. Get instant access to private channels and off-market leads.
        </p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-6 opacity-40 grayscale pointer-events-none w-full max-w-3xl">
          <div className="bg-surface-container-low p-6 rounded-2xl flex flex-col items-start gap-3 text-left">
            ...
            <span className="font-label text-xs font-bold">Real-time alerts</span>
          </div>
          <div className="bg-surface-container-low p-6 rounded-2xl flex flex-col items-start gap-3 text-left">
            <span className="material-symbols-outlined text-primary">groups</span>
            <span className="font-label text-xs font-bold">Owner Network</span>
          </div>
          <div className="bg-surface-container-low p-6 rounded-2xl flex flex-col items-start gap-3 text-left">
            <span className="material-symbols-outlined text-primary">description</span>
            <span className="font-label text-xs font-bold">Encrypted Docs</span>
          </div>
        </div>
      </div>
    </DashboardLayout>
