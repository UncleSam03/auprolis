/* src/pages/dashboard/seller/NewListingStep2.jsx */
  ...
  return (
    <SellerDashboardLayout title="Media & Specifications">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Intelligence Banner */}
        <div className="mt-12 bg-surface-container-low p-10 rounded-3xl flex items-center gap-10 border-l-8 border-primary shadow-authoritative pb-16">
          <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center shadow-authoritative shrink-0 animate-pulse">
            <span className="material-symbols-outlined text-primary text-4xl" style={{ fontVariationSettings: "'FILL' 1" }}>auto_awesome</span>
          </div>
          <div>
            <h4 className="text-lg font-headline font-[900] text-primary mb-2 uppercase tracking-widest">Editorial Enhancement</h4>
            <p className="text-on-surface-variant leading-relaxed font-medium opacity-70">Our system automatically color-corrects uploaded images and extracts 3D metadata to generate a virtual intelligence twin for institutional buyers.</p>
          </div>
        </div>
      </div>
